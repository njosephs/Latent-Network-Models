...
&\ \ \ \ \ \ \ \ \times f_{MVN}(\mu_{k_i}, \sigma_{k_i}^2I_2)\times\lambda_i \times \frac{1}{G} \times f_{MVN}(0, I_2) \times f_{\chi^2_2} \\
&\ \ \ \ \ \ \ \ \times f_{MVN}(\mu_{k_j}, \sigma_{k_j}^2I_2)\times  \lambda_j \times \frac{1}{G} \times f_{MVN}(0, I_2) \times f_{\chi^2_2} \\
...
\begin{align*}
f_{\sigma_{k_i}^2|\theta, Y}(\sigma_{k_i}^2|\theta, Y) &\propto \frac{1}{2\sigma_{k_i}}\exp\left\{-\frac{1}{2\sigma_{k_i}^2}(Z_i-\mu_{k_i})^T(Z_i-\mu_{k_i})\right\}\exp\left\{-\frac{\sigma_{k_i}^2}{2}\right\}\\
&\propto (\sigma_{k_i}^2)^{-1/2}\exp\left\{-\frac{1}{2\sigma_{k_i}^2}(Z_i-\mu_{k_i})^T(Z_i-\mu_{k_i})-\frac{\sigma_{k_i}^2}{2}\right\}
\end{align*}
