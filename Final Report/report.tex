...
Finally, we look at the conditional for the latent variable $Z_i$: \textbf{TEX}

\begin{align*}
f_{Z_i | \theta, Y}(Z_i | \theta, Y)
\end{align*}

Since this is not a distribution we know how to sample from, we use a Metropolis-Hastings step. Here, we describe the proposal and subsequent rejection ratio. \textbf{TEX}
