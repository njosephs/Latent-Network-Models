...
For the E-step, we observe that the beta distribution is conjugate to the binomial and since the $p_{ij}$ are iid, we have the following likelihood. Note we just suppress our parameters $\theta = \{\alpha, \beta\}$.
