...
\graphicspath{"/Users/benjamindraves/Documents/Work/github/Courses/MA 589/Latent-Twitter-Models/Final Report/report_figures/"}
...
\begin{figure}
    \centering
   % \includegraphics[width = 0.75\textwidth]{{"EM/heatmap_dist_weighted"}.pdf}
\end{figure}
\end{frame}
